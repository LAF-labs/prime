...
function DialogFooter({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'flex flex-col-reverse gap-2 border-t bg-muted/72 px-6 py-4 sm:flex-row sm:flex-wrap sm:justify-end sm:rounded-b-[calc(var(--radius-2xl)-1px)]',
        className,
      )}
